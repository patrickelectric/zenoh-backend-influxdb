          ...
          volumes: {
            ...
            influxdb: {
              ...
              private: {
                ...
                //NOTE: For influxdb v2.x, the influxdb rust library currently doesn't provide for creating and dropping the database but it is still required to keep a token value here
                //token: "token"
              }
            }
          },
          storages: {
            ...
            demo: {
              ...
              volume: {
                ...
                // NOTE: For influxdb v2.x, the influxdb rust library currently doesn't provide for creating the database so this db should already exist
                db: "zenoh_example",
                
                // if the database doesn't exist, create it
                // NOTE: For influxdb v2.x, the influxdb rust library currently doesn't provide for creating the database so this value sshould be kept false
                create_db: false,
                // strategy on storage closure
                // NOTE: For influxdb v2.x, the influxdb rust library currently doesn't provide for dropping the database so this should NOT be kept to drop_db
